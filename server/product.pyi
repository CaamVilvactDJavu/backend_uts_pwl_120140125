...
class Product(_message.Message):
    ...
    image_url: str
    stock: int
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., description: _Optional[str] = ...,
                 price: _Optional[float] = ..., image_url: _Optional[str] = ..., stock: _Optional[int] = ...) -> None: ...
...
class ProductListResponse(_message.Message):
    ...
    message: str
    def __init__(self, products: _Optional[_Iterable[_Union[Product, _Mapping]]]
...
class ProductResponse(_message.Message):
    ...
    product: Product
    message: str
    def __init__(self, product: _Optional[_Union[Product, _Mapping]]
                 = ..., message: _Optional[str] = ...) -> None: ...
...
class ProductCreateRequest(_message.Message):
    ...
    image_url: str
    stock: int
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., price: _Optional[float]
                 = ..., image_url: _Optional[str] = ..., stock: _Optional[int] = ...) -> None: ...
...
class ProductUpdateRequest(_message.Message):
    ...
    image_url: str
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., description: _Optional[str] = ...,
                 price: _Optional[float] = ..., stock: _Optional[int] = ..., image_url: _Optional[str] = ...) -> None: ...
